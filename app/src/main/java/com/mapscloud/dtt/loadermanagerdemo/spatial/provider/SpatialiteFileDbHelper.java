...
public class SpatialiteFileDbHelper extends SQLiteOpenHelper {
     ...
     * @param dbName
     */
    public SpatialiteFileDbHelper(Context context, File dbDir, String dbName) {
        super(context, dbName, null, DB_VERSION, new DefaultDatabaseErrorHandler());
        mContext = context;
        mDbPath = dbDir.getAbsolutePath();
        mAssetName = null;
        mDbUri = null;
