...
public class SpatiAtlasContract {
    ...
    public static final String PATH_100W = "";

    public static void setBaseContentUri(Uri baseContentUri) {
    ...
    public static class GeometryTable implements GeometryColumn, BaseColumns {
        ...
        public static final Uri buildUri(String table, int srid, double simplificationTolerance, int limit, int offset) {
            ...
            if (limit > 0 && offset > 0) {
                b.appendQueryParameter("limit", offset + "," + limit);
            } else if (limit > 0) {
